  ...
  Widget _cameraPreviewWidget() {
    if (controller == null || !controller!.value.isInitialized!) {
      ...
      return AspectRatio(
        ...
        child: Stack(
          children: [
            CameraPreview(controller!), // Camera preview remains fully visible

            // Circular capture area with opacity
            Positioned(
              top: 100,
              left: 0,
              right: 0,
              child: Center(
                child: Opacity(
                  opacity: 0.5, // Adjust opacity for the circular capture area
                  child: Container(
                    width: 200.0,
                    height: 200.0,
                    decoration: BoxDecoration(
