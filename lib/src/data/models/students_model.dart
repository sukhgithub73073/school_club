...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
    ...
    promotionClassId: json["promotion_class_id"],
    promotionClassGroupId: json["promotion_class_group_id"],
    ...
    latestPromotion: json["latest_promotion"],
  );
